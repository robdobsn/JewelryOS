...
#include <stdio.h>
#include <stdint.h>
#include "SimpleMovingAvg_Eval.h"

class RateEstimator_Eval
{
public:
    RateEstimator_Eval(int maxRateBPM, int minRateBPM)
    {
...
private:
    ...
    SimpleMovingAverage_Eval<50> _sample_interval_ms_avg;
